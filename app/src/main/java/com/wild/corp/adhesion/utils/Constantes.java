...
public class Constantes {
    ...
    public static final List<String> STATUTS_ENCOURS = List.of("Attente validation adhérent", "Attente paiement", "Attente validation secrétariat", "Attente licence en ligne");
